...
F10::
	...
	Loop
	{
		...
		ControlSend, , {Numpad0}, ahk_id %ID%
		Sleep 9000 ; feel free to change to make it quicker
		...
		ControlSend, , {Numpad4}, ahk_id %ID%
		ControlSend, , {Numpad0}, ahk_id %ID%
		Sleep 24000 ; had random lag break it, totaling 22,31, and 32 seconds. Because of time, it tabbed into chat instead. feel free to change to make quicker
